...
class RAGFlowPdfParser:
    def __init__(self):
        ...
        try:
            ...
            model_dir = snapshot_download(
                ...
                local_dir=os.path.join(get_project_base_directory(), "weights"),
    ...
    def __images__(self, fnm, zoomin=3, page_from=0,
        ...
        try:
            ...
            # turn any page (including cropped pages) into an PageImage object
            ...
            for i, p in enumerate(self.pdf.pages[page_from:page_to]):
                p0 = self.pdf.pages[i + page_from]
                im = p0.to_image(resolution=72 * zoomin)
        ...
        try:
            # pdfreader-class
            # https://pypdf.readthedocs.io/en/latest/modules/PdfReader.html#the-pdfreader-class
            self.pdf = pdf2_read(fnm if isinstance(fnm, str) else BytesIO(fnm))
            # https://pypdf.readthedocs.io/en/latest/modules/PdfReader.html#pypdf.PdfReader.outline
        ...
        # pdfplumber转化出的PageImage object
